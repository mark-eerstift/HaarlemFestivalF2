...
namespace ProjectWebApplicatie.Controllers
{
    public class DancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EvenementID,Locatie,BeginTijd,EindTijd,TicketsTotaal,TicketsVerkocht,EvenementPrijs,Session,Artiest")] Dance dance)
        {
